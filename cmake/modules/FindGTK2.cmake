...
if (GTK2_LIBRARIES AND GTK2_INCLUDE_DIRS)
  ...
  IF ( GTK2_MIN_VERSION )
    PKG_SEARCH_MODULE( GTK2 ${_pkgconfig_REQUIRED} gtk+-2.0>=${GMODULE2_MIN_VERSION} )
  ELSE ( GTK2_MIN_VERSION )
    PKG_SEARCH_MODULE( GTK2 ${_pkgconfig_REQUIRED} gtk+-2.0 )
  ENDIF ( GTK2_MIN_VERSION )
  
  IF ( NOT GTK2_FOUND AND PKG_CONFIG_FOUND )
...
ENDIF( FALSE )
 ENDIF ( NOT GTK2_FOUND AND PKG_CONFIG_FOUND )
